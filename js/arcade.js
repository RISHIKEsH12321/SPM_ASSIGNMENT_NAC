...
function createGrids(num){
    ...
    // Loop to generate 400 div elements with unique IDs
    for (let i = 1; i <= 400; i++) {
...
function drop(event) {
    ...
    if (cell.classList.contains('grid-cell')) {
        ...
        img.classList.add("gridImgInGrid");
...
function calculateRoadPoints() {
    ...
    for (let row = 0; row < 20; row++) { // Assuming a 20x20 grid for initial implementation
        let rowStart = row * 20;
        let currentRow = [];
